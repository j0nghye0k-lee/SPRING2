...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		// TestBean t0 = ctx.getBean("test1" ,TestBean.class);
		// id가 tes1인 bean 객체의 주소값을 받아온다.
		TestBean t1 = ctx.getBean("test1", TestBean.class); // 아이디를 안적었고 추출도 안됐음. 왜냐하면
		...
		TestBean t3 = ctx.getBean("test2", TestBean.class); // ctx.getBean에서 객체가 생성됨
